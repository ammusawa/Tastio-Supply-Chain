    ...
    const fetchMeal = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setValue('price', mealData.price);
          setValue('availability', mealData.availability);
          
          // Set preview image if exists
          if (mealData.image_url) {
            setPreviewImage(getImageUrl(mealData.image_url));
          } else {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Update your meal information and settings
              </p>
            </div>
          </div>
        </div>
